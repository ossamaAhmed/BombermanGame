...
public class ModifyProfileView extends JPanel
{
	 ...
	 */
	public ModifyProfileView(JFrame x,UserDatabase DB){
		super();
		myframe=x;
		this.DB=DB;
	    this.setOpaque(true);
	...
	public void setUserFirstNameTextField(){
		...
		userFirstNameInput.setText(this.DB.getCurrentUser().getFullName());
	...
	public void setUserNameTextField(){
		...
		userNameInput.setText(this.DB.getCurrentUser().getUserName());
	...
	public void setPasswordTextField(){
		...
		userPasswordInput.setText(this.DB.getCurrentUser().getPassword());
	...
	public void setConfirmPasswordTextField(){
		...
		confirmUserPasswordInput.setText(this.DB.getCurrentUser().getPassword());
	...
	private void setConfirmButtonActionPerformed(ActionEvent evt) {
	        ...
	        int errorNum=myController.modifyProfile(userFirstNameInput.getText(), userNameInput.getText(), userPasswordInput.getText(), confirmUserPasswordInput.getText());
	        if(errorNum==3){
