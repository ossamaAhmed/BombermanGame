...
public class User 
{
	 ...
	 * @param fileName gives the location where the savedGames.txt database should be created 
	 ...
	 * @param myBoard is the current gameBoard of the user
	 * @param saveGameName give the location where the savedGames.txt database should be created
	 * @return a boolean, true if the savedGames.txt database was created, false otherwise 
	 */
	 ...
	 * @param gameName is the user's inputted GameName
	 * @param dateTime is the datestamp of when the Game was saved
	 ...
	 * CSVfiles\ username
	 * @param loadGameName is the user's inputted GameName which is being checked for
	 ...
	 * @param user whose saved game list needs to be returned
	 * @return an Arraylist of Type String with all the saved game names. Only returns the Game Names and not the Date/Time stamp
	 */
	...
	/**
	 * Calling this Getter function returns user's full name 
	 * @return String
	 */
	...
	/**
	 * Calling this Setter function sets user's full name 
	 * @param name
	 */
	...
	/**
	 * Calling this Getter function returns username 
	 * @return
	 */
	...
	/**
	 * Calling this Setter function sets username 
	 * @param userName
	 */
	...
	/**
	 * Calling this Getter function returns current user's password 
	 * @return String
	 */
	...
	/**
	 * Calling this Setter function sets current user's password
	 * @param password
	 */
	...
	/**
	 * Calling this Setter function sets current user's score
	 * @param score
	 */
	...
	/**
	 * Calling this Getter function returns current user's unlocked levels number 
	 * @return
	 */
	...
	/**
	 * Calling this Setter function sets current user's unlocked levels number 
	 * @param unlockedLevel
	 */
	 ...
	 * @param killedEnemies ArrayList of Enemy objects killed by the bomb 
	 */
	...
	/**
	 * Calling this Getter function returns current user's score
	 * @return int 
	 */
	...
	/**
	 * Used to set root folder for JUNIT testing
	 * @param folderName
	 */
